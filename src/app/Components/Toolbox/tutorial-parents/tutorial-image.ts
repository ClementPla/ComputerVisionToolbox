import {AfterContentChecked, AfterContentInit, AfterViewInit, ChangeDetectorRef, Component, ContentChild, Directive, Injectable, Input, OnInit, ViewChild } from '@angular/core';
